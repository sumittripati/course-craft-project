            ...
            <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
              <Link to="/">
                <div className='flex items-center'>
                  <img src={logo} width={40} height={42} loading='lazy' />
                  <span className='text-[1.5rem] font-bold text-richblack-5'>
                    TechStudy
                  </span>
                </div>
        ...
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            <div className="flex ">
              ...
              <Link to='https://github.com/sumittripati' target="__blank" className="text-white hover:underline mr-1"
              >
                Sumit Tripathi
              </Link>
            </div>
            <span> © 2025 TechStudy</span>
          </div>

          <div className="flex items-center">
            <Link to="https://www.linkedin.com/in/thesumittripathi" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImLinkedin2 size={17} />
            </Link>
            <Link to="https://github.com/sumittripati" className="text-white p-3 hover:bg-richblack-700 rounded-full duration-300" target="_blank" rel="noopener noreferrer">
              <ImGithub size={17} />
            </Link>
          </div>
